export default function Achievements() {
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center py-12 sm:px-6 px-8 [text-shadow:_2px_2px_5px_var(--tw-shadow-color)] shadow-black">
      <div className="flex flex-col sm:w-1/2 text-left sm:flex-row items-center justify-center gap-4 sm:gap-8">
        <div className="flex flex-col gap-4 transition-all duration-200">
          ...
          <ul className="list-disc list-inside">
            <li>PwC Hack A Day 2024 1st Runner Up (2024)</li>
            <li>Cyber Jawara International 2024 2nd Place (2024)</li>
